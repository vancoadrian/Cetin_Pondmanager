...
export const auditActionLabels: Record<string, string> = {
  ...
  'cabin_catalog.updated': 'Ponuka chát upravená',
  'closure.created': 'Uzávierka vytvorená',
  'closure.updated': 'Uzávierka upravená',
  ...
  'fish.manager_presence.started': 'Prítomnosť správcu zapnutá',
  'fish.manager_presence.stopped': 'Prítomnosť správcu ukončená',
  'fish.observation.created': 'Nové meranie ryby',
  'fish.registered': 'Ryba začipovaná',
  'fish.settings.updated': 'Pravidlá veľkých rýb upravené',
  'fish.status.changed': 'Stav ryby zmenený',
  'map.background_uploaded': 'Podklad mapy nahraný',
  ...
  'notification.alert.ended': 'Oznam ukončený',
  'notification.fish_assistance.created': 'Správca upozornený na veľkú rybu',
  'notification.large_catch.created': 'Upozornenie na veľký úlovok',
  'notification.place_issue.created': 'Prevádzka upozornená na nedostatok',
  ...
  'notification.tournament.assigned': 'Kontrolór upozornený na pridelenie',
  'notification.tournament.created': 'Súťažné roly upozornené',
  'payment_methods.updated': 'Platobné možnosti upravené',
  ...
  'tournament.operations_mode.updated': 'Režim súťaže upravený',
  ...
  'tournament.team_registration.created': 'Prihláška tímu vytvorená',
