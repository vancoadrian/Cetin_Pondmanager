...
export const auditActionLabels: Record<string, string> = {
  ...
  'notification.subscription.mock_saved': 'Mock odber uložený',
  ...
  'system.data_backup.cleanup': 'Safety backupy vyčistené',
  'system.data_backup.downloaded': 'Safety backup stiahnutý',
  'system.data_backup.loaded': 'Safety backup načítaný',
  'system.data_export.downloaded': 'Backup stiahnutý',
  'system.data_import.previewed': 'Backup skontrolovaný',
  'system.data_import.restored': 'Backup obnovený',
