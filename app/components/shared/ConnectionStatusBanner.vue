...
<template>
  <!--
    Deliberately not `fixed`: this renders before AppHeader (also
    `sticky top-0`) in app.vue. Staying in normal flow makes the header
    get pushed down while the banner is visible instead of the two
  ...
  >
    <div
      ...
      class="relative z-50 border-b px-4 py-2 text-sm font-semibold shadow-sm"
